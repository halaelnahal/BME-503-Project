...
# bug_memory['spider'] = [0.49, 0.51, -100, 1, 0]
bug_memory['bird'] = [0.49, 0.51, -100, 1, 0]
bug_memory['bat'] = [0.49, 0.51, -100, 1, 0]
bug_memory['snake'] = [0.49, 0.51, -100, 1, 0]
bug_memory['chicken'] = [0.49, 0.51, -100, 1, 0]
bug_memory['duck'] = [0.49, 0.51, -100, 1, 0]

# food
bug_memory['sunflower'] = [0.49, 0.51, 100, 0, 1]
bug_memory['strawberry'] = [0.49, 0.51, 100, 0, 1]
bug_memory['rose'] = [0.49, 0.51, 100, 0, 1]
bug_memory['leaf'] = [0.49, 0.51, 100, 0, 1]
bug_memory['orange'] = [0.49, 0.51, 100, 0, 1]
