...
image = ['Images/7.jpg', 'Images/1.jpg', 'Images/2.jpg', 'Images/6.jpg', 'Images/3.jpg', 'Images/4.jpg', 'Images/8.jpg', 'Images/9.jpg']
ABL=imgparams(image)
...
# agressor synapses
w = 2 #originally 2
syn_rr_a = Synapses(sl, sbr, clock=Clock(0.2 * ms), model='''
                g_synmax:1
                ''',
                    on_pre='''
		z+= g_synmax
...
syn_ll_a = Synapses(sr, sbl, clock=Clock(0.2 * ms), model='''
                g_synmax:1
                ''',
                    on_pre='''
		z+= g_synmax
...
image_plot2=plot(ABL[1][4],ABL[1][5],'kx')
image_plot3=plot(ABL[2][4],ABL[2][5],'rs')
image_plot4=plot(ABL[3][4],ABL[3][5],'yo')
image_plot5=plot(ABL[4][4],ABL[4][5],'gD')
image_plot6=plot(ABL[5][4],ABL[5][5],'c^')
image_plot7=plot(ABL[6][4],ABL[6][5],'m+')
image_plot8=plot(ABL[7][4],ABL[7][5],'C0p')
...
def update_plot():
    global imagex, imagey, bug_plot, image_plot1, image_plot2, image_plot3, image_plot4, image_plot5, image_plot6, image_plot7, image_plot8, sr_plot, sl_plot, index, ABL
    bug_plot[0].remove()
#    image_plot[0].remove()
    ...
    image_plot5[0].remove()
    image_plot6[0].remove()
    image_plot7[0].remove()
    image_plot8[0].remove()
#    sr_plot[0].remove()
#    sl_plot[0].remove()
